...
// // Set up the PDF.js worker and font URL
// pdfjsLib.GlobalWorkerOptions.workerSrc = 'pdfjs-dist/legacy/build/pdf.worker.mjs'; // Adjust this path
// pdfjsLib.GlobalWorkerOptions.standardFontDataUrl = 'pdfjs-dist/standard_fonts/LiberationSans-Regular.ttf'; // Set the correct path for the font file
...
//       console.log(`Using regex: ${regex} on text: "${normalizedText}"`); // Add this line for debugging
